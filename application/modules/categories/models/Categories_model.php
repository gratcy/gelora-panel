...
class Categories_model extends CI_Model {
    ...
    function __get_categories() {
		$this -> db -> select("a.*,b.cname as cparentname FROM categories_tab a LEFT JOIN categories_tab b ON b.cid=a.cparent WHERE a.ctype=1 AND (a.cstatus=1 OR a.cstatus=0) ORDER BY a.cparent ASC, a.cname ASC", FALSE);
